 ...
 */
const QuerySection = ({ initialValue, editorHeight, executeQuery, minHeight }) => {
  ...
  const queryBtn = `w-full py-4 rounded-bl-lg rounded-br-lg ${isDarkMode ? "bg-primaryDark text-slate-900 hover:bg-secondaryDark" : "bg-primaryDark text-slate-50 hover:bg-secondaryLight"} font-bold duration-300`;
