...
const container =`article-card min-w-article-pc flex flex-col gap-2 border-1 rounded-lg p-4 duration-500 ${isDarkMode ? "bg-slate-800 border-slate-700" : "bg-slate-100 border-slate-200" }`;
